...
try:
    ...
    with sync_playwright() as p:
        ...
        def nav_click(selector):
            if selector.startswith('[data-'):
                ...
                if parent.count() and parent.get_attribute('open') is None:
                    parent.locator('summary').first.click()
        ...
        nav_click('[data-nav-area=rosticero]')
        ...
        nav_click('[data-tab=requestForm]')
        ...
        nav_click('[data-tab=kitchenPlanning]')
        ...
        nav_click('[data-tab=kitchenProduction]')
        ...
        nav_click('[data-tab=weeklyPurchases]')
