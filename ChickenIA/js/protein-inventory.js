...
(()=>{
 ...
 $('#date').max=today;
 const actions={initial:'Primera captura: lo que hay en CEDIS',send:'SALIDA A CHICANITO MÓVIL — se resta de CEDIS',entry:'Llegó pollo del proveedor — se suma',marinate:'Ya marinamos estos pollos — siguen en CEDIS',receive:'Chicanito Móvil: confirmar lo que llegó',count:'Contar los pollos — solo comparar',waste:'Pollo perdido o dañado — se resta',rectify:'RECTIFICAR INVENTARIO — corregir lo que hay'};
