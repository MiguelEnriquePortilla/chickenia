...
(() => {
  ...
  async function load(){
    ...
    if(next){const destination=new URL(next,window.location.origin);if(destination.origin===window.location.origin&&['/dashboard.html','/preguntale.html','/supervision.html','/captura.html','/rastro.html'].includes(destination.pathname)){window.location.replace(destination.href);return;}}
